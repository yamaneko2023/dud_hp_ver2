        ...
        <div class="container">
            ...
            <div class="careers-message">
                <p>
                    ...
                    テレワーク中心、週1-2日出社、プロジェクトベースなど、働き方は自由に可能な限り可能です。
                    子育て中の方、副業で始めたい方、フリーランスとして関わりたい方も大歓迎です。<br><br>

                    <strong>学び続けられる環境</strong><br>
                    最新のAI技術を業務で積極的に活用し、スキルアップを支援します。
                    実務を通じて、データ分析、LLMアプリケーション開発、システム構築のスキルを習得できます。
                    ...
                    個人や小規模事業者、様々な規模のお客様に寄り添うビジネススタイルなので、
        ...
        <div class="container">
            ...
            <div class="careers-cta">
                ...
                <div class="cta-buttons">
                    <a href="/contact" class="btn-primary-large">お問い合わせ</a>
                    <a href="/company" class="btn-primary-large">会社概要を見る</a>
                    <a href="/vision" class="btn-primary-large">ビジョンを見る</a>
                </div>
            </div>
        </div>
    </section>
